"""
Insurance Spam Detection System - Pure Python HTTP Server
        ...
        <div class="content">
            <div class="input-section">
                ...
                <div style="margin-bottom: 20px;">
                    <div class="tabs">
                        <button class="tab-btn active" onclick="switchTab(event, 'email')">📧 Email</button>
                        <button class="tab-btn" onclick="switchTab(event, 'sms')">💬 SMS</button>
                        <button class="tab-btn" onclick="switchTab(event, 'phone')">☎️ Phone</button>
                        <button class="tab-btn" onclick="switchTab(event, 'text')">✍️ Text</button>
                    </div>
                </div>
...
{{"is_spam": true/false, "confidence": 0-100, "risk_level": "high/medium/low", "reasons": [list], "recommendation": "text"}}"""
...
if __name__ == '__main__':
    ...
    print(f"\n{'='*60}")
    print(f"🛡️  Insurance Spam Detection System")
    print(f"{'='*60}")
